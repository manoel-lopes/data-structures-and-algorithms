// import HashTable from '../data-structures/map-and-hash-table/hash-table'
import HashTable from './data-structures/map-and-hash-table/hash-table-separate-chaining'
